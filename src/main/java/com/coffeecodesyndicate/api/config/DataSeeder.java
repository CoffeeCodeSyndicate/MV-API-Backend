...
public class DataSeeder implements CommandLineRunner {
    ...
    @Autowired
    public DataSeeder(PetRepository petRepository, UserRepository userRepository, ApplicationRepository applicationRepository, PasswordEncoder passwordEncoder){
    ...
    public void run(String...args) throws Exception {
        // Create and encode passwords for all users before saving
        User registered = new User();
        registered.setUsername("lukePowell8");
        registered.setPassword(passwordEncoder.encode("pass123#"));
        registered.setEmail("powell8@example.com");
        registered.setLoggedIn(false);
        ...
        registered2.setPassword(passwordEncoder.encode("pass456#"));
        registered2.setEmail("petLover@example.com");
        registered2.setLoggedIn(false);
        registered2.setAdmin(false);

        User registered3 = new User();
        registered3.setUsername("billBrown");
        registered3.setPassword(passwordEncoder.encode("dogs4Life"));
        registered3.setEmail("brownFamily@example.com");
        registered3.setLoggedIn(false);
        registered3.setAdmin(false);

        User registered4 = new User();
        registered4.setUsername("paisClanton");
        registered4.setPassword(passwordEncoder.encode("p$2015"));
        registered4.setEmail("Paisley@example.com");
        registered4.setLoggedIn(false);
        registered4.setAdmin(false);
